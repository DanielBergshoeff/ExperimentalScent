...
public class GridNode
{
    ...
    public GridNode ParentNode;//For the AStar algoritm, will store what node it previously came from so it cn trace the shortest path.
    ...
    public GridNode(bool a_bIsWall, Vector3 a_vPos, int a_igridX, int a_igridY)//Constructor
    {
